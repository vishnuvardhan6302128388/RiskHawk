...
import {ConversationContainer,TopContainer,Content,SubContent} from "./styledComponents"
...
const ConversationSection=()=>{
    ...
    const TopSection=()=>(
        <TopContainer>
            ...
            <button type="button" className="btn8">Escalate</button>
        </TopContainer>
    )
    ...
    const ContentSection=()=>(
        <Content>
          ...
          <SubContent>
                <img src="https://res.cloudinary.com/dg3ufv9bj/image/upload/v1733102813/eqfpmxvoqla4lcsendek.png" alt="time-line"/>
                <div className="chatContainer">
                    ...
                    <div className="name-container2">
                       ...
                       <div className="profile-container2">
                          ...
                          <p className="time">9:08 PM Received By WhatsApp <TiTick size={40} color="green"/></p>  
                       </div>
                    ...
                    <p className="text">Lorem ipsum dolor sit amet consectetur.
                         ...
                         Egestas mattis pellentesque nibh dui sed malesuada dolor eget ipsum. Molestie nam morbi id arcu volutpat arcu.
                    </p>
                    ...
                    <div className="name-container2">
                       ...
                       <div className="profile-container2">
                          ...
                          <p className="time2">27Jul, 2024 9:08 PM Sent By WhatsApp <TiTick size={40} color="green"/></p>  
                       </div>
                       <BsThreeDots className="dots" size={20}/>
                    </div>
                    <p className="text">Lorem ipsum dolor sit amet consectetur.
                    ...
                    <div className="inputContainer">
                        <div className="radiobox-container">
                            ...
                            <label htmlFor="sms" className="label">SMS</label>
                        ...
                        <div className="message-container">
                            <input type='text' placeholder="Type a Message..." className="inputEl" />
                            <LuLink className="media" size={30}/>
                            <button type="button" className="btn10"><IoMdSend size={30}/>Send</button>
                        </div>
                    </div>
                </div>
            </SubContent>
